  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/bg_image_1.jpg);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal">My Booking(
          <?php 
            $list11 = $database->query("select  booking_id from  booking where patientname='$username';");
              ...
              <input type="Submit" value="Search" id="button-addon1" class="login-btn btn-outline-primary btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
               ...
               <?php
                    if($_POST){
                      ...
                      $sqlmain= "select * from booking where patientname='$namep'";
                  }
              ?>
                        ...
                        <tbody>
                            ...
                            <?php                                
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="booking.php"><button  class="login-btn btn-primary btn" >&nbsp; Show all My booking &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
