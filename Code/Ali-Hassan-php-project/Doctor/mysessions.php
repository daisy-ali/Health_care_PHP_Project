...
if($_POST){
  $idsch=$_POST["schid"];
  $database->query("delete from schedule where scheduleid='$idsch';");
  $database->query("delete from booking where schedule_id='$idsch';");
      ...
      <div class="container text-center wow fadeInUp">
        <nav aria-label="Breadcrumb">
          <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0 mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">mysessions</li>
          </ol>
        </nav>
        <h1 class="font-weight-normal">My Sessions(
          <?php 
            $list11 = $database->query("select  scheduleid from  schedule where docid='$username';");
              ...
              <input type="Submit" value="Search" id="button-addon1" class="login-btn btn-outline-primary btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
               ...
               <?php
                    if($_POST){
                      ...
                      $sqlmain= "select * from schedule where docid='$username'";
                            ...
                            <?php                                
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <button type="submit"  class="btn-primary btn button-icon btn-delete"  ><font class="tn-in-text">Delete Session</font></button>
                                      </form>
                                        </td>
                                    </tr>';
