      ...
      <div class="container text-center wow fadeInUp">
        <nav aria-label="Breadcrumb">
          <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0 mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">mypatient</li>
          </ol>
        </nav>
        <h1 class="font-weight-normal">My Patients(
          <?php 
                        ...
                        <tbody>
                            ...
                            <?php                                
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="mypatient.php"><button  class="login-btn btn-primary btn" >&nbsp; Show all Patients &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    $namep=$row["patientname"];
                                    $sqlmain2= "select * from patient where  pname='$namep'";
