...
if($_POST){
    ...
    if ($newpassword == $cpassword) {
      ...
      if ($result->num_rows == 1) {
          ...
          $manager_insert_query = "INSERT INTO `manager`(`mname`, `mnumber`, `memail`, `mpassword`, `mnic`)
                                   VALUES ('$name','$number','$email','$newpassword','$nic')";
          if ($database->query($manager_insert_query) === TRUE) 
          {
              $webuser_insert_query = "INSERT INTO webuser (name, usertype) VALUES ('$name', 'm')";
...
<header>
  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/bg_image_1.jpg);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal">Add New User</h1>
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp"><span class="text-primary">Add</span> User</h1>
      <form action="" method="POST" class="contact-form mt-5">
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-primary wow zoomIn">Add User</button>
        </div>
      </form>
    </div>
  </div>
