<?php
    ...
    if($_GET){
        $id=$_GET["id"];
        $sqlmain= "select * from doctor where doid='$id'";
    ...
    if($_POST){
        ...
        if ($newpassword == $cpassword) {
            $doctor_update_query =" UPDATE `doctor` SET `doid`='$docid',`dname`='$name',`dnumber`='$number',`demail`='$email',`dpassword`='$newpassword',`NIC`='$nic',`city`='$city',`specialties`='$spec' WHERE doid = $docid";
      ...
      <div class="container text-center wow fadeInUp">
        <nav aria-label="Breadcrumb">
          <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0 mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">edit_doctor</li>
          </ol>
        </nav>
        <h1 class="font-weight-normal">Edit Doctor Data</h1>
