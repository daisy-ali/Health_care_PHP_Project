  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/bg_image_1.jpg);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal">All appointment(
          <?php 
            $list11 = $database->query("select  booking_id from  booking;");
            ...
            for ($y=0;$y<$list11->num_rows;$y++){
              ...
              ?>   </select>    
                <?php
                  ...
                  $list11 = $database->query("select  doctorname from  booking;");
                  for ($y=0;$y<$list11->num_rows;$y++){
                      $row0=$list11->fetch_assoc();
                      $d=$row0["doctorname"];
              ...
              <input type="Submit" value="Search" id="button-addon1" class="login-btn btn-outline-primary btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
               ...
               <?php
                    if($_POST){
                      ...
                      $sqlmain= "select * from booking where doctorname='$keyword'";
                  }else{
                      $sqlmain= "select * from booking order by booking_id desc";
