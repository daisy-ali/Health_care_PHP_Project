  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/bg_image_1.jpg);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal">All Schedule are Session (
          <?php 
            $list11 = $database->query("select  scheduleid,title from schedule;");
            echo $list11->num_rows; 
          ?>)</h1>
          <a class="btn btn-primary ml-lg-3" href="../admin/add_schedule.php">Add New Schedule Session</a>
      </div> 
    </div>
  </div>
                        ...
                        <tbody>
                            ...
                            <?php                                
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="schedule.php"><button  class="login-btn btn-primary btn" >&nbsp; Show all Schedules &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
