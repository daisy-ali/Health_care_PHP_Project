    ...
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal">All Doctors (
          ...
          ?>)</h1>
          <a class="btn btn-primary ml-lg-3" href="../admin/add_doctor.php">Add New Doctor</a>
      </div> 
    </div>
  </div>
            ...
            <form action="" method="post" class="header-search">
              ...
              <input type="search" name="search" class="form-control" placeholder="Search Doctor name or City" list="doctors" aria-describedby="button-addon1">&nbsp;&nbsp;
                ...
                <?php
                  ...
                  $list11 = $database->query("select  dname,city from  doctor;");
                            ...
                            <?php                                
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <td>
                                        <form action="edit_doctor.php" method="get">
                                        ...
                                        <input type="text" value="'.$docid.'" name="id" style="display: none;">
                                        <button type="submit"  class="btn-primary btn button-icon btn-delete"  ><font class="tn-in-text">Delete</font></button>
                                      </form>
                                        </td>
                                    </tr>';
