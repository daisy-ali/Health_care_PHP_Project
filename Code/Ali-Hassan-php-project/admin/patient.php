...
if($_GET){
  ...
  $name=($result001->fetch_assoc())["pname"];
  $sql= $database->query("delete from webuser where name='$name';");
  $sql1= $database->query("delete from patient where pname='$name';");
  $sql2= $database->query("delete from booking where patientname='$name';");
  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/bg_image_1.jpg);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal">All Patients(
          <?php 
    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <form action="" method="post" class="header-search">
              ...
              <input type="search" name="search" class="form-control" placeholder="Search Patient name or City" list="doctors" aria-describedby="button-addon1">&nbsp;&nbsp;
                            
                <?php
                  echo '<datalist id="patients">';
                  $list11 = $database->query("select  pname,city from  patient;");
              ...
              <input type="Submit" value="Search" id="button-addon1" class="login-btn btn-outline-primary btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
               ...
               <?php
                    if($_POST){
                      ...
                      $sqlmain= "select * from patient where city='$keyword' or city='$keyword%' or city='%$keyword' or city='%$keyword%' or pname='$keyword' or pname like '$keyword%' or pname like '%$keyword' or pname like '%$keyword%'";
                  }else{
                        ...
                        <tbody>
                            ...
                            <?php                                
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="patient.php"><button  class="login-btn btn-primary btn" >&nbsp; Show all Patients &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <td>
                                        <form action="edit_patient.php" method="get">
